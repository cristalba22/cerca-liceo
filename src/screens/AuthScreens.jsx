...
export function LoginScreen({ authNotice, onBack, onLogin, onForgotPassword, onQuickAccess, allowQuickAccess, onRegister, onToggleTheme }) {
...
export function ForgotPasswordScreen({ authNotice, onBack, onSubmit, onToggleTheme }) {
...
export function ResetPasswordScreen({ authNotice, onBack, onSubmit, onToggleTheme }) {
...
export function ProfileScreen({ account, local, onBack, onLogin, onRegister, onMerchantPanel, onPublish, onAdmin, onResetSession, onUpgradeToMerchant, onPrivacy, authNotice, onToggleTheme }) {
...
export function PrivacyScreen({ onBack, onToggleTheme }) {
  return (
...
export function RegisterScreen({ initialType = 'neighbor', onComplete, onBack, onLogin, onToggleTheme }) {
